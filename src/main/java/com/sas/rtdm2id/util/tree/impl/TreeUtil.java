...
public class TreeUtil {
    ...
    public GenericTree<Short> createTree(Batch.LogicalUnit logicalUnit) {
        ...
        for (CrossTableNodeDataDO crossTableNodeDataDO : logicalUnit.getCrossTableNodeDataDOs()) {
            objIdOutputNodesMap.put(crossTableNodeDataDO.getObjid(), crossTableNodeDataDO.getOutputNodes().getValue());
            nodeIdObjIdMap.put(crossTableNodeDataDO.getNodeId(), crossTableNodeDataDO.getObjid());
            nodeIdObjectHashMap.put(crossTableNodeDataDO.getNodeId(),
                    new RTDMObject("crossTable", crossTableNodeDataDO));
            objIdToNodeIdMap.put(crossTableNodeDataDO.getObjid(), crossTableNodeDataDO.getNodeId());
            nodeIdInputNodesMap.put(crossTableNodeDataDO.getNodeId(), crossTableNodeDataDO.getInputNodes().getValue());
        }
