...
public class BranchStep2 {
  ...
  private List<BranchCase2> branchCases = null;

  @JsonProperty("defaultCase")
  private ConditionBranch2 defaultCase = null;

  public BranchStep2 name(String name) {
    this.name = name;
    return this;
  }
  ...
  public BranchStep2 branchType(String branchType) {
  ...
  public BranchStep2 branchCases(List<BranchCase2> branchCases) {
    this.branchCases = branchCases;
    return this;
  }

  public BranchStep2 addBranchCasesItem(BranchCase2 branchCasesItem) {
   ...
   * @return branchCases
   **/
   public List<BranchCase2> getBranchCases() {
    return branchCases;
  }

  public void setBranchCases(List<BranchCase2> branchCases) {
    this.branchCases = branchCases;
  }

  public BranchStep2 defaultCase(ConditionBranch2 defaultCase) {
   ...
   * @return defaultCase
   **/
  public ConditionBranch2 getDefaultCase() {
    return defaultCase;
  }

  public void setDefaultCase(ConditionBranch2 defaultCase) {
    this.defaultCase = defaultCase;
  }
  ...
  public boolean equals(Object o) {
    ...
    BranchStep2 branchStep2 = (BranchStep2) o;
    return Objects.equals(this.name, branchStep2.name) &&
            Objects.equals(this.branchType, branchStep2.branchType) &&
            Objects.equals(this.branchCases, branchStep2.branchCases) &&
            Objects.equals(this.defaultCase, branchStep2.defaultCase);
  }
