...
public class AuditTerm {
  ...
  public AuditTerm(String name) {
    this.name = name;
  }

  public AuditTerm name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AuditTerm auditTerm = (AuditTerm) o;
    return Objects.equals(this.name, auditTerm.name);
  }
