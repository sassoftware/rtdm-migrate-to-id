 ...
 */
@ApiModel(description = "A paginated list of decision node type representations, with optional links to first, prev, next, and last page of the collection.")
...
public class DecisionNodeTypeCollection extends BaseCollection2 {
   ...
   * @return items
   **/
  @ApiModelProperty(required = true, value = "Array consisting of one page of Decision Node Type resources.")
